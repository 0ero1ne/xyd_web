...
<style scoped>
	...
	.tip { margin-bottom: 22rpx; padding: 22rpx 25rpx; border-radius: 16rpx; color: #475569; font-size: 24rpx; background: #eaf4eb; }
	.card { margin-bottom: 22rpx; padding: 0 26rpx; border: 1rpx solid #edf0ed; border-radius: 22rpx; background: #fff; box-shadow: 0 12rpx 32rpx rgba(17, 24, 39, 0.05); }
	...
	.title { color: #111827; font-size: 29rpx; font-weight: 600; } .desc { margin-top: 8rpx; color: #7b887f; font-size: 23rpx; }
</style>
